  ...
  <div class="container">
    ...
    <div class="data">
      <div class="total-users item">
        ...
        <div class="icon">
          <el-avatar size="large">
            <i-ep-UserFilled id="icon"></i-ep-UserFilled>
          </el-avatar>
        </div>
      </div>
      <div class="active-users item">
        ...
        <div class="icon">
          <el-avatar size="large">
            <i-ep-CircleCheckFilled id="icon"></i-ep-CircleCheckFilled>
          </el-avatar>
        </div>
      </div>
      <div class="inactive-users item">
        ...
        <div class="icon">
          <el-avatar size="large">
            <i-ep-WarningFilled id="icon"></i-ep-WarningFilled>
          </el-avatar>
        </div>
      </div>
